...
@section('extra-css')
    ...
    <link href="{{ asset('backend/assets/css/dashboard/dash_2.css') }}" rel="stylesheet" type="text/css" class="dashboard-analytics" />
@endsection
                    ...
                    <div class="widget-content">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('backend/assets/assets/img/camera.jpg') }}" alt="product">Camera</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('backend/assets/assets/img/shoes.jpg') }}'" alt="product">Shoes</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('backend/assets/assets/img/headphones.jpg') }}" alt="product">Headphone</div></td>
