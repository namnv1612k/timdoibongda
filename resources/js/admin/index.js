...
import perfect_scollbar from 'perfect-scrollbar';
window.PerfectScrollbar = perfect_scollbar;
...
window.BackendTheme = function() {
    ...
    var toggleFunction = {
        sidebar: function($recentSubmenu) {
            $('.sidebarCollapse').on('click', function (sidebar) {
                ...
                let get_CompactSubmenuShow = document.querySelector('#compact_submenuSidebar');
                var get_overlay = document.querySelector('.overlay');
                let get_mainContainer = document.querySelector('.main-container')
    ...
    var inBuiltfunctionality = {
        ...
        onSidebarClick: function() {
            let getMenu;
            getMenu = document.querySelectorAll('.menu');

            for (let i = 0; i < getMenu.length; i++) {
                getMenu[i].addEventListener('click', function() {

                    let get_body = $('body');
                    let getHref = this.querySelectorAll('.menu-toggle')[0].getAttribute('href');
                    let getElement = document.querySelectorAll('#compact_submenuSidebar > ' + getHref)[0];
                    let getMenuShowElement = document.querySelector('.menu.show');
                    let getCompactSubmenu = document.querySelector('#compact_submenuSidebar');
                    let getOverlayElement = document.querySelector('.overlay');
                    let getElementActiveClass = document.querySelector('#compact_submenuSidebar > .show');
                    let get_mainContainer = document.querySelector('.main-container')
